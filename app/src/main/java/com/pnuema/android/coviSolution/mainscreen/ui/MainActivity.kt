package com.pnuema.android.coviSolution.mainscreen.ui
...
import com.pnuema.android.coviSolution.details.ui.DetailsActivity
import com.pnuema.android.coviSolution.fullmap.ui.FullMapActivity
import com.pnuema.android.coviSolution.helpers.Errors
import com.pnuema.android.coviSolution.mainscreen.ui.adapters.SearchResultsAdapter
import com.pnuema.android.coviSolution.mainscreen.ui.models.LocationResult
import com.pnuema.android.coviSolution.mainscreen.ui.viewholders.LocationClickListener
import com.pnuema.android.coviSolution.mainscreen.ui.viewmodels.MainScreenViewModel
import com.pnuema.android.coviSolution.persistance.FavoritesDatabase
import com.pnuema.android.coviSolution.persistance.daos.Favorite
...
class MainActivity : AppCompatActivity(), LifecycleOwner, LocationClickListener {
    ...
    override fun onPrepareOptionsMenu(menu: Menu?): Boolean {
        ...
        menu?.findItem(R.id.menu_item_location_search2)?.let {
            (it.actionView as? SearchView).let { searchView ->
                searchView?.let { view ->
                    this.searchView = searchView
                    view.maxWidth = Integer.MAX_VALUE // to make sure it occupies the entire screen width as possible.
                    view.setQuery("Diagnostics", true )
        ...
        menu?.findItem(R.id.menu_item_location_search3)?.let {
            (it.actionView as? SearchView).let { searchView ->
                searchView?.let { view ->
                    this.searchView = searchView
                    view.maxWidth = Integer.MAX_VALUE // to make sure it occupies the entire screen width as possible.
                    view.setQuery("Blood", true )
